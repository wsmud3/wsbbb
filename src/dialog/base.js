...
const Dialog = {
    ...
    reset: function () {
        ...
        if (this.message) {
            ...
            this.message.isLoad = false;
            this.message.unRead = 0;
            this.message.selected_item = 0;
            this.message.selectedChild = null;
            this.message.listElement = null;
            this.message.detailElement = null;
        ...
        if (this.jh) {
            this.jh.isLoad = false;
            this.jh.selected_item = null;
        }
        if (this.events) this.events.unRead = 0;
        this.isShow = false;
        this.curItem = null;
