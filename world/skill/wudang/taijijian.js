				...
				rao: {
								...
								use: function (me, target, lv) {
												...
												if (me.do_attack({
																...
																gj: me.gj,
																mz: me.mz,
																attack_msg: "<mag>$N使出太极剑「绕字诀」，剑光连绵不绝地卷向$n</mag>",
																damage_msg: "<cyn>$n被连绵剑气所困，手忙脚乱，无法脱身！</cyn>"
												})) {
																target.add_status({
																				id: "rao",
																				name: "缠绕",
																				...
																				duration: time,
																				prop: { is_busy: 1 },
																				start_msg: "<cyn>$n被太极剑的连绵剑气缠绕，忙乱" + (time / 1000) + "秒！</cyn>",
																				finish_msg: "<cyn>$N终于挣脱了太极剑的缠绕。</cyn>",
																});
