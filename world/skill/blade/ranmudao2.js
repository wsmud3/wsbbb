...
this.parry_actions = [
	"$n横刀当胸，$w上燃起熊熊真焰，$N的攻击尚未近身便被热浪逼退",
	"$n刀势一转，$w划出一道火弧，以燃木刀意将$N的攻势焚于无形",
	"$n默运内力，$w上烈焰升腾，在身前布下一道火墙，$N难以寸进",
	"$n以刀代守，$w上火光吞吐，$N的兵刃袭来竟被灼得发烫",
	"$n刀光化作一团烈火，燃木刀法攻守合一，$N的攻势尽被烈焰吞没"
];
