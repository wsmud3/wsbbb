this.inherits(SKILL);
this.name = "天山六阳掌";
this.id = "liuyangzhang2";
this.source_skill = "liuyangzhang";
this.grade = 4;
...
this.parry_actions = [
"$n双掌交错，天山六阳掌「<YEL>落日熔金</YEL>」守势施出，以阳刚之力将$N的攻击格开",
"$n身形飘然一转，一式「<MAG>日斜归路晚霞明</MAG>」守招展开，$N的攻势如落日余晖般消散",
"$n掌影翻飞，天山六阳掌「<HIW>云霞出海曙</HIW>」守势从容应对，$N的攻击被片片掌影化解",
"$n运起逍遥内力，一招「<HIC>青阳带岁除</HIC>」以柔克刚，$N的猛攻被轻描淡写地卸去",
"$n不闪不避，天山六阳掌「<YEL>阳歌天钧</YEL>」守招硬接$N的攻击，纯阳掌力将攻势反震而回"
];
