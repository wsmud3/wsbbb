this.inherits(SKILL);
this.name = "降龙十八掌";
this.id = "xianglongzhang2";
this.source_skill = "xianglongzhang";
this.grade = 5;
...
this.parry_actions = [
"$n双掌沉稳推出，降龙十八掌「见龙在田」守势展开，以刚制刚将$N的攻击封在圈外",
"$n沉声吐气，一招「亢龙有悔」反守为攻，掌力层层叠叠将$N的攻势尽数逼回",
"$n身形凝立如山，降龙十八掌「时乘六龙」守势运转，双掌翻飞如六龙护体封住$N攻势",
"$n不退反进，一式「龙战于野」以攻代守，$N的攻击被刚猛无匹的掌力正面撞回",
"$n双掌交错如十字，降龙十八掌「神龙摆尾」守招施出，$N的猛攻被浑厚掌劲扫向一旁"
];
